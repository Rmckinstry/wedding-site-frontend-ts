...
const AdminGuestCard = (props: AdminGuestCardProps) => {
        ...
        <>
          <div className="box border-box-100">
            <div className="flex-row-start" style={{ justifyContent: "space-between" }}>
              <span className="font-sm secondary-text">{guest.name}</span>
              <div>
                {editable ? (
                  <button
            ...
            <div>
              {editable ? (
                ...
                <span>Song Requests: {guest.song_requests}</span>
              )}
            </div>
          </div>
        </>
